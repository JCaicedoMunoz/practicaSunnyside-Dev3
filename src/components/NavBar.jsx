  ...
  return (
    <nav className=" sm:h-[24px] " >
      ...
      md:w-[500px]`}>
        ...
        <li className="cursor-pointer bg-yellow w-[140px] h-[56px]  grid place-content-center rounded-full font-fraunces text-black   uppercase sm:bg-white sm:hover:bg-opacity-25 sm:hover:text-white">Contact</li>
      </ul>
